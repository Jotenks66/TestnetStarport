...
func (*MsgCreatePost) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3b21aafdd108b7b, []int{0}
}
...
func (*MsgCreatePostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d3b21aafdd108b7b, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "GaupaLabs.gaupachain.gaupachain.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "GaupaLabs.gaupachain.gaupachain.MsgCreatePostResponse")
}

func init() { proto.RegisterFile("gaupachain/tx.proto", fileDescriptor_d3b21aafdd108b7b) }

var fileDescriptor_d3b21aafdd108b7b = []byte{
	// 236 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x4e, 0x4f, 0x2c, 0x2d,
	0x48, 0x4c, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17,
	0x92, 0x77, 0x07, 0x09, 0xfa, 0x24, 0x26, 0x15, 0xeb, 0x21, 0xa4, 0x91, 0x98, 0x4a, 0xc1, 0x5c,
	...
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/GaupaLabs.gaupachain.gaupachain.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/GaupaLabs.gaupachain.gaupachain.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "GaupaLabs.gaupachain.gaupachain.Msg",
